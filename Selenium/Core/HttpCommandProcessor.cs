...
namespace Selenium
{
	...
	public class HttpCommandProcessor : ICommandProcessor
	{
		...
		{
            //log.Debug("Enter HttpCommandProcessor");
            ...
            //log.Debug("Exit HttpCommandProcessor");
		...
		{
            //log.Debug("Enter HttpCommandProcessor no port");
        ...
        public string DoCommand(string command, string[] args)
        {
            ...
            log.Debug("Enter Do Command: " + command);
		...
		public void Start() 
		{
            log.Info("Create New Browser Session");
			string result = GetString("getNewBrowserSession", new String[] {browserStartCommand, browserURL, extensionJs});

            //Check if not ok here FGJ
            log.Info("New Browser Session Result: " + result);
			sessionId = result;
		}
		...
		public void Stop() 
		{
            log.Info("Stop Previous Browser Session");
