...
namespace Selenium
{
	...
	public class DefaultSelenium : ISelenium
	{
		...
		public void Start()
		{
            log.Debug("Start Command Processor");
		...
		public void Stop()
		{
            log.Debug("Stop Command Processor");
		...
		public void Click(String locator)
		{
            ...
            if (locator.Substring(0, 5) == "link=" || locator == "//input[@type='submit']" || locator == "ct100_ct100_MainContent_content_btnSearch")
            {
                if (locator == "link=People" || locator == "link=Groups" || locator == "link=Ministry" || locator == "link=WebLink" || locator == "link=Giving" || locator == "link=Admin" || locator == "link=Reports"
                    || locator == "link=Individual" || locator == "locator=Member/Env #" || locator == "link=Date of birth" || locator == "link=Change" || locator == "link=Find person" || locator == "link=Add")
		...
		public void WaitForPageToLoad(String timeout)
		{
            ...
            Assert.IsFalse(GetTitle().Contains("Object reference not set to an instance of an object."), "Null reference exception");
            Assert.IsFalse(GetTitle().Contains("The app setting"), "Missing app setting");
		}
        ...
        /// <summary>
        /// Verifies the expected title of the current page.
        /// </summary>
        /// <param name="expectedTitle">the expected title</param>
        public void VerifyTitle(String expectedTitle)
        {
            Assert.AreEqual(expectedTitle, commandProcessor.GetString("getTitle", new String[] { }));
        }
        ...
        {
            Assert.AreEqual(true, commandProcessor.GetBoolean("isTextPresent", new String[] { text, }), "Did not find the expected text: " + text);
        }


        /// <summary>Verifies that the specified text pattern appears somewhere on the rendered page shown to the user.
        /// </summary>
        /// <param name="textArray">an array of expected text</param>
        public void VerifyTextPresent(String[] textArray)
        {
        ...
        /// <summary>Verifies that the specified text pattern appears somewhere on the rendered page shown to the user.
        /// </summary>
        /// <param name="textList">an ilist of expected text</param>
        public void VerifyTextPresent(IList<string> textList)
        {
		...
		/// <summary>Verifies the element provided by the user exists on the current page.
		/// </summary>
		/// <param name="pattern">the pattern for the expected element</param>
		public void VerifyElementPresent(String pattern) {
			Assert.AreEqual(true, commandProcessor.GetBoolean("isElementPresent", new String[] { pattern, }), String.Format("The element {0} could not be found!", pattern));
		}

		/// <summary>Verifies the element provided by the user does not exist on the current page.
		/// </summary>
		/// <param name="pattern">the pattern for the expected element</param>
		public void VerifyElementNotPresent(String pattern) {
			Assert.AreEqual(false, commandProcessor.GetBoolean("isElementPresent", new String[] { pattern, }), String.Format("The element {0} is present!", pattern));
		}

		/// <summary>
		/// Verifies the specified element is visible to the user.
		/// </summary>
		/// <param name="locator">an element locator</param>
		public void VerifyIsVisible(String locator)
		{
			Assert.IsTrue(commandProcessor.GetBoolean("isVisible", new String[] {locator,}));
		}

		/// <summary>
		/// Verifies the specified element is not visible to the user.
		/// </summary>
		/// <param name="locator">an element locator</param>
		public void VerifyIsNotVisible(String locator)
		{
			Assert.IsFalse(commandProcessor.GetBoolean("isVisible", new String[] {locator,}));
		}

        /// <summary>Clicks on a link, button, checkbox or radio button and waits for
        /// the page to load.
		/// </summary>
		/// <param name="locator">an element locator</param>
        /// <returns>the current datetime</returns>
        public DateTime ClickAndWaitForPageToLoad(String locator)
        {
            commandProcessor.DoCommand("click", new String[] { locator, });
            DateTime clickTime = TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time"));

            try {
                commandProcessor.DoCommand("waitForPageToLoad", new String[] { "60000", });
            }
            catch (SeleniumException) {
                commandProcessor.DoCommand("waitForCondition", new String[] { "selenium.browserbot.getCurrentWindow().document.readyState == 'complete'", "30000", });
            }

            return clickTime;
        }

        /// <summary>Selects an item and waits for the page to load.
        /// </summary>
        /// <param name="locator">an element locator</param>
        /// <param name="optionLocator"></param>
        public void SelectAndWaitForPageToLoad(String locator, String optionLocator)
        {
        ...
        /// <summary>Clicks on a link, button, checkbox or radio button and runs the specified
        /// JavaScript snippet repeatedly until it evaluates to "true".
        /// </summary>
        /// <param name="locator">an element locator</param>
        /// <param name="script">the JavaScript snippet to run</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        public void ClickAndWaitForCondition(String locator, String script, String timeout)
        {
            commandProcessor.DoCommand("click", new String[] { locator, });
            commandProcessor.DoCommand("waitForCondition", new String[] { script, timeout, });
        }
        ...
        /// <summary>
        /// Clicks a control that will result in a popup being displayed, waits for the popup to open,
        /// and selects the window.
        /// </summary>
        /// <param name="locator">an element locator</param>
        /// <param name="windowID">the JavaScript window ID of the window to select</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        public void ClickAndSelectPopUp(String locator, String windowID, String timeout)
        {
            commandProcessor.DoCommand("click", new String[] { locator, });
            commandProcessor.DoCommand("waitForPopUp", new String[] { windowID, timeout, });
            commandProcessor.DoCommand("selectPopUp", new String[] { windowID, });
        ...
        /// <summary>
        /// Navigates to the specified page in portal.
        /// </summary>
        /// <param name="pagePath">The '›' delimited path to the page in portal</param>
        public void Navigate(String pagePath)
        {
            string[] pagePathSplit = pagePath.Split('›');

            // Assumes [0] = tab, [1] = sub menu, [2] = menu item, [3] = link
            commandProcessor.DoCommand("click", new String[] { String.Format("link={0}", pagePathSplit[0].Trim()), });
            WaitForCondition("selenium.isElementPresent(\"xpath=//div[@id='nav_sub' and @style='overflow: visible;']\");", "10000");
            ClickAndWaitForPageToLoad(String.Format("//div[@style='visibility: visible;']/dl/dt[contains(text(), '{0}')]/following-sibling::dd/a[contains(text(), '{1}')]", pagePathSplit[1].Trim(), pagePathSplit[2].Trim()));
            //ClickAndWaitForPageToLoad(String.Format("link={0}", pagePathSplit[2].Trim()));

            if (pagePathSplit.Length > 3) {
                ClickAndWaitForPageToLoad(String.Format("link={0}", pagePathSplit[3].Trim()));
            }
        }

        /// <summary>Simulates a user pressing and releasing a key then runs the specified JavaScript snippet repeatedly until it evaluates to "true".
        /// The snippet may have multiple lines, but only the result of the last line
        /// will be considered.
        /// </summary>
        /// <param name="locator">an <a href="#locators">element locator</a></param>
        ...
        /// <param name="script">the JavaScript snippet to run</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        public void KeyPressAndWaitForCondition(String locator, String keySequence, String script, String timeout)
        {
            commandProcessor.DoCommand("keyPress", new String[] { locator, keySequence, });
            commandProcessor.DoCommand("waitForCondition", new String[] { script, timeout, });
        }
        ...
        /// <summary>
        /// Simulates a user pressing and releasing a key then waits for a new page to load.
        /// </summary>
        /// <param name="locator">an <a href="#locators">element locator</a></param>
        /// <param name="keySequence">Either be a string("\" followed by the numeric keycode  of the key to be pressed, normally the ASCII value of that key), or a single  character. For example: "w", "\119".</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        public void KeyPressAndWaitForPageToLoad(String locator, String keySequence, String timeout)
        {
            commandProcessor.DoCommand("keyPress", new String[] { locator, keySequence, });
        ...
        /// </summary>
        /// <param name="locator">an element locator</param>
        /// <param name="optionLocator">an option locator</param>
        /// <param name="script">the JavaScript snippet to run</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        public void SelectAndWaitForCondition(String locator, String optionLocator, String script, String timeout)
        {
            commandProcessor.DoCommand("select", new String[] { locator, optionLocator, });
            commandProcessor.DoCommand("waitForCondition", new String[] { script, timeout, });
        }
