...
namespace Selenium
{
	...
	public interface ISelenium
	{
        ...
        /// <summary>Verifies the title provided by the user matches the title displayed
        /// to the user.
        /// </summary>
        ...
        /// <summary>Verifies the text provided by the user exists on the current page.
        /// </summary>
        ...
        /// <summary>Verifies the text provided by the user exists on the current page.
        /// </summary>
        /// <param name="textArray">the expected text</param>
        void VerifyTextPresent(String[] textArray);
		...
		/// </summary>
		/// <param name="locator">an element locator</param>
		void VerifyIsVisible(String locator);

		/// <summary>
		/// Verifies the specified element is not visible to the user.
		/// </summary>
		/// <param name="locator">an element locator</param>
		void VerifyIsNotVisible(String locator);


        /// <summary>Clicks on a link, button, checkbox or radio button and waits for a new page to load.
        /// </summary>
        /// <param name="locator">an element locator</param>
        /// <returns>the current datetime</returns>
        DateTime ClickAndWaitForPageToLoad(String locator);
        ...
        /// <param name="selectLocator">an <a href="#locators">element locator</a> identifying a drop-down menu</param>
        /// <param name="optionLocator">an option locator (a label by default)</param>
        void SelectAndWaitForPageToLoad(String selectLocator, String optionLocator);
        ...
        /// <param name="script">the JavaScript snippet to run</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        void ClickAndWaitForCondition(String locator, String script, String timeout);
        ...
        /// <param name="script">the JavaScript snippet to run</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        void KeyPressAndWaitForCondition(String locator, String keySequence, String script, String timeout);
        ...
        /// <param name="keySequence">Either be a string("\" followed by the numeric keycode  of the key to be pressed, normally the ASCII value of that key), or a single  character. For example: "w", "\119".</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        void KeyPressAndWaitForPageToLoad(String locator, String keySequence, String timeout);
        ...
        /// <param name="script">the JavaScript snippet to run</param>
        /// <param name="timeout">a timeout in milliseconds, after which this command will return with an error</param>
        void SelectAndWaitForCondition(String locator, String optionLocator, String script, String timeout);
