...
namespace FellowshipOne.Api.People.Model {
    ...
    [Serializable]
    [XmlRoot("results")]
    public class HouseholdCollection : Collection<Household> {
        public HouseholdCollection() { }
        public HouseholdCollection(List<Household> households) {
            if (households != null) {
                this.AddRange(households);
            }
        }
    }
}