...
namespace FellowshipOne.Api.Activities.Sets {
    public class Rosters : ApiSet<Model.Roster> {
        ...
        private const string LIST_URL = "/activities/v1/activities/{0}/rosters";
        private const string GET_URL = "/activities/v1/activities/{0}/rosters/{1}";
        private const string SEARCH_URL = "/activities/v1/activities/{0}/rosters/search";
