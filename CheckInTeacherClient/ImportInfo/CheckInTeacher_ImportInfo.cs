...
namespace FTTests.ImportInfo
{
    ...
    class CheckInTeacher_InportInfo : CheckInBaseWebDriver
    {
        [Test, RepeatOnFailure]
        [Category(TestCategories.Services.SmokeTest)]
        [Author("Grace Zhang")]
        [Description("Verifies Security Code right")]
        public void CheckInTeacher_Login_Verify_SecurityCode()
        {
            ...
            try
            {
                ...
                String securityCode = test.CheckIn.GetSecurityCodeByStudentName("Emma", null, "Kemp");
        ...
        public void CheckInTeacher_Login_Verify_Birthday()
        {
            TestBaseWebDriver test = base.TestContainer[Gallio.Framework.TestContext.CurrentContext.Test.Name];
            try
            {
        ...
        public void CheckInTeacher_Login_Verify_TagComment()
        {
            TestBaseWebDriver test = base.TestContainer[Gallio.Framework.TestContext.CurrentContext.Test.Name];
            try
            {
        ...
        public void CheckInTeacher_Login_Verify_LastAttendance()
        {
            TestBaseWebDriver test = base.TestContainer[Gallio.Framework.TestContext.CurrentContext.Test.Name];
