...
namespace FTTests.CheckInTeacher
{
    ...
    class CheckInTeacher_Settings : CheckInBaseWebDriver
    {
        [Test, RepeatOnFailure]
        [Category(TestCategories.Services.SmokeTest)]
        [Author("Grace Zhang")]
        [Description("Verifies the teacher's name")]
        public void CheckInTeacher_Settings_CheckTeacherName()
        {
        ...
        public void CheckInTeacher_Settings_SelectOneClassroom()
        {
            TestBaseWebDriver test = base.TestContainer[Gallio.Framework.TestContext.CurrentContext.Test.Name];
            //Login
            test.CheckIn.LoginWebDriver();
        ...
        public void CheckInTeacher_Settings_CheckSSO()
        {
            TestBaseWebDriver test = base.TestContainer[Gallio.Framework.TestContext.CurrentContext.Test.Name];
        ...
        public void CheckInTeacher_Settings_CheckMyAccount()
        {
            TestBaseWebDriver test = base.TestContainer[Gallio.Framework.TestContext.CurrentContext.Test.Name];
        ...
        public void CheckInTeacher_Settings_CheckFooters()
        {
            TestBaseWebDriver test = base.TestContainer[Gallio.Framework.TestContext.CurrentContext.Test.Name];
